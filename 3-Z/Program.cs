...
namespace _3_Z
{
    ...
    {
        /// <summary>
        /// Метод, который ищет длину самой длинной строки
        /// </summary>
        ...
        /// <summary>
        /// Выводит строки из диапазона
        /// </summary>
        /// <param name="array">массив строк</param>
        /// <param name="s1">начало диапазона</param>
        /// <param name="s2">конец диапазона</param>
        ...
        /// <summary>
        /// выводит строки начинающиеся с символа (который вводит пользователь)
        /// </summary>
        /// <param name="array">массив строк</param>
        /// <param name="simv">символ введённый пользователем</param>
